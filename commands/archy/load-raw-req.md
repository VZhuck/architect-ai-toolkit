---
description: "Load Jira Capability/Epic/Story (or other) work items into ai-workflow/raw-requirements/ via the archy-load-raw-req skill."
...
```
/archy:load-raw-req CAP-123 ABC-45 ABC-99
/archy:load-raw-req CAP-123, ABC-45, ABC-99
/archy:load-raw-req CAP-123,ABC-45,ABC-99
```
...
More examples:
```
/archy:load-raw-req CAP-123
/archy:load-raw-req EPIC-45 --children
/archy:load-raw-req ABC-789
/archy:load-raw-req EPIC-45 EPIC-99 --children     # --children applies to every key that supports it
/archy:load-raw-req                                # no keys given → falls back to .env JIRA_KEYS
/archy:load-raw-req --children                     # same fallback, --children still applies
```
