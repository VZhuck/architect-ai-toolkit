# meeting-decision-logging Specification

## Purpose

Summarize a meeting note into technical decisions, semantically flag likely duplicates against the existing Architecture Decision Log (ADL), ask the user which to log, and append confirmed rows via a script.
