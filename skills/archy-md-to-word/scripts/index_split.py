"""Split archy-word-to-md's 00.Index.md into cover preamble vs. materialized TOC list.

00.Index.md (per skills/archy-word-to-md/scripts/sad_structure.py's build_index) contains
