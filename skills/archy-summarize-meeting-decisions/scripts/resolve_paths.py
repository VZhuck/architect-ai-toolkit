#!/usr/bin/env python3
"""Resolve inputs for the archy-summarize-meeting-decisions skill.
...
skills/archy-md-to-word/scripts/md_to_word.py's resolve_template style:
...
Usage:
  ...
  uv run python skills/archy-summarize-meeting-decisions/scripts/resolve_paths.py --meeting-file notes/standup.md
  uv run python skills/archy-summarize-meeting-decisions/scripts/resolve_paths.py --adl-path sad/07.Decision-Acceptance-Board.md
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Resolve meeting note and ADL paths for archy-summarize-meeting-decisions."
    )
    parser.add_argument(
        "--meeting-file",
        default=None,
